...
export default function ChangePassword() {
  ...
  return (
    <div className="flex justify-center items-center flex-col h-screen md:bg-[url('/home-bg.svg')] md:w-full bg-gradient-to-r from-cyan-100 via-cyan-200 to-cyan-300 m-0">
